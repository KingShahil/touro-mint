        ...
        <div className="footer-top">
          <div className="row">
            <div className="col-md-6 col-lg-3 about-footer">
              ...
              <ul>
                <li><a href="tel:(010) 1234 4321"><FaPhone className="me-2" />(010) 1234 4321</a></li>
                <li>
            ...
            <div className="col-md-6 col-lg-4 open-hours">
              ...
              <table className="table">
                <tbody>
                  <tr>
                    <td><FaMapMarkerAlt className="me-2" />Monday Thursday</td>
                    <td>9:00am - 5:00pm</td>
                  </tr>
                  <tr>
                    <td><FaMapMarkerAlt className="me-2" />Friday</td>
                    <td>9:00am - 4:00pm</td>
                  </tr>
                  <tr>
                    <td><FaMapMarkerAlt className="me-2" />Saturday</td>
                    <td>9:00am - 1:30pm</td>
                  </tr>
                  <tr>
                    <td><FaMapMarkerAlt className="me-2" />Sunday</td>
              ...
              <div className="footer-logo">
                <table>
                  <tbody>
                    <tr>
                      <td><img src="https://i.ibb.co/vxc577d/dummy-logo3.jpg" alt="logo1" /></td>
                      <td><img src="https://i.ibb.co/vxc577d/dummy-logo3.jpg" alt="logo2" /></td>
                      <td><img src="https://i.ibb.co/vxc577d/dummy-logo3.jpg" alt="logo3" /></td>
                      <td><img src="https://i.ibb.co/vxc577d/dummy-logo3.jpg" alt="logo4" /></td>
                      <td><img src="https://i.ibb.co/vxc577d/dummy-logo3.jpg" alt="logo5" /></td>
                    </tr>
                  </tbody>
                </table>
              </div>
